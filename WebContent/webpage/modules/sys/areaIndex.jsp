...
<body class="gray-bg">
	...
	<div id="content" class="row">
		<div id="left" style="background-color:#e7eaec" class="col-sm-1">
			<input id="search_condition" type="text" placeholder="请输入区域名称" class="form-control pull-left" style="width: 200px;margin-top: 10px" onblur="searchNode()"/>
		...
		<div id="right"  class="col-sm-11  animated fadeInRight">
			<iframe id="areaContent" name="areaContent" src="${ctx}/sys/area/list?id=" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	</div>
	</div>
		...
		var tree, setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
				//	var id = treeNode.pId == '0' ? '' :treeNode.pId;
					...
					$('#areaContent').attr("src","${ctx}/sys/area/list?id="+id);
				}
			}
		};
