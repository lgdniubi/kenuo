	...
	<script type="text/javascript">
		...
		function addDiyDom(treeId, treeNode) {
			...
			if(treeNode.pId != 1 && treeNode.pId != 0){
				...
				if($("#shiroEdit").val() == 1){
					editStr = editStr + "<a href=\"#\" onclick=\"openDialog('修改机构', '${ctx}/sys/office/form?id="+treeNode.id+"&&num="+treeNode.num+"','800px', '700px')\" class=\"btn btn-success btn-xs\"><i class=\"fa fa-edit\"></i> 修改</a>";
				}
				if($("#shiroDel").val() == 1){
