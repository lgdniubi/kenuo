...
//   注  ：  未表明原注释的注释  为2016年11月10日11:41:16   咖啡 注释	
					//新注释
		   ...
		   <tbody>
		      <tr>
				...
				<td class="width-15 active">
					<label class="pull-right"><font color="red">*</font>角色等级:</label>
				</td>
				<td class="width-35">
					<form:input path="roleGrade" maxlength="3" onkeyup="this.value=this.value.replace(/\D/g,'')" class="form-control required"/>
				</td>
				<!-- 新注释 -->
		     <%--    <td class="width-35">
		        	<form:select path="roleGrade" class="form-control ">
						<form:options items="${fns:getDictList('sys_role_grade')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select>
					<span class="help-inline">
						添加新的角色时，需要在字典管理中（sys_role_grade）添加新的等级
					</span>
				</td>  --%>	
		      ...
		      <tr>
		        ...
		        <!--  <td  class="width-15" class="active"><label class="pull-right">角色类型:</label></td>
		         <td class="width-35"> -->
					...
					<span class="help-inline" title="activiti有3种预定义的组类型：security-role、assignment、user 如果使用Activiti Explorer，需要security-role才能看到manage页签，需要assignment才能claim任务">
						工作流组用户组类型（超级管理员:1;普通管理员:2;培训师:3;美容师:4）</span>
				</td>
		      </tr> --%>
		      <tr>
