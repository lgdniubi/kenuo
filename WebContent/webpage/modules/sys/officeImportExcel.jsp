...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function importFileTemplate(){
			window.location.href= '${ctx}/sys/office/import/template';
		}
...
<body>
	<form id="inputForm" action="${ctx}/sys/office/import" method="post" enctype="multipart/form-data" style="padding-left:20px;"><br/>
		<input id="uploadFile" accept=".xls,.xlsx" name="file" type="file" style="width:330px"/>
		导入文件不能超过5M，仅允许导入“xls”或“xlsx”格式文件！
	</form>
	<shiro:hasPermission name="sys:office:template">
