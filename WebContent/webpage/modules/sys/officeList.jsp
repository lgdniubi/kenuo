   					...
   					 	success:function(data){
							...
							for(var i=0;i<dataObj.length;i++){   
								...
								if(dataObj[i].grade == '1'){
									//操作权限-添加
									if($("#shiroAdd").val() == 1){
										html += "<a href=\"#\" onclick=\"openDialogView('添加通用设备', '${ctx}/ec/specEquipment/shopComEquipmentList?shopId="+dataObj[i].id+"','800px', '620px')\" class=\"btn  btn-primary btn-xs\"><i class=\"fa fa-plus\"></i> 设备</a>";
									}
								}
								...
								if(dataObj[i].grade == '1'){
									...
									if($("#arrangeOrdinary").val() == 1){
										html += "<a href=\"#\" onclick=\"top.openTab('${ctx }/train/arrange/ArrangeOrdinary?officeId="+dataObj[i].id+"&officeName="+dataObj[i].name+"','美容师排班', false)\" class=\"btn btn-success btn-xs\">美容师排班</a>";
									}
								}
								html += "</td>";
								html += "</tr>";
