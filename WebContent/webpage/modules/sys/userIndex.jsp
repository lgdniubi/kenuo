...
<body class="gray-bg">
	...
	<div id="content" class="row">
		<div id="left"  style="background-color:#e7eaec" class="leftBox col-sm-1">
			<input id="search_condition" type="text" placeholder="请输入机构名称" class="form-control pull-left" style="width: 200px;margin-top: 10px" onkeyup="searchNode()"/>
			<a onclick="refresh()" class="pull-right" style="margin-top: 18px">
				<i class="fa fa-refresh"></i>
			</a>
			<div id="ztree" class="ztree leftBox-content"></div>
			<input type="hidden" id="parentDel" value="0">
	...
	<script type="text/javascript">
		...
		var setting = {
			...
			callback:{onClick:function(event, treeId, treeNode){
					...
					var parentDel = $('#parentDel').val();
					$('#officeContent').attr("src","${ctx}/sys/user/list?office.id="+id+"&office.name="+treeNode.name+"&parentDel="+parentDel);
				}
			}
		};
