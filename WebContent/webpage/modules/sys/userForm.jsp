		   ...
		   <tbody>
			 ...
			 <input id="userinfo.birthday" name="userinfo.birthday" type="text" maxlength="20" class="laydate-icon form-control layer-date input-sm"
		  	...
		  	<tr>
		  		...
		  		<td class="active"><label class="pull-right">等级:</label></td>
		  		<td><form:input path="userinfo.userlevel" class="form-control" type="text"  value=""/></td>
		  	</tr>
		  	<tr>
		  	...
		  	<tr>
		  		...
		  		<td colspan="3"><sys:treeselect id="speciality" name="speciality.id" value="${user.speciality.id}" labelName="speciality.name" labelValue="${user.speciality.name}"
