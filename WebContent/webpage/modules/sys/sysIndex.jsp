...
<head>
    ...
    <title>登云信息化管理平台</title>

	<%@ include file="/webpage/include/head.jsp"%>
	<script src="${ctxStatic}/common/inspinia.js?v=3.2.0"></script>
	<script src="${ctxStatic}/common/contabs.js"></script> 
    <meta name="keywords" content="培训平台">
    <meta name="description" content="培训平台">
...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            --%>
                             <span class="clear">
                             	<span class="block m-t-xs"><strong class="font-bold">${fns:getUser().name}</strong></span>
                             	<span class="text-muted text-xs block">${fns:getUser().roleNames}</span>
                             </span>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="footer">
                <div class="pull-left"> &copy;  登云美业</div>
            </div>
        </div>
        <!--右侧部分结束-->
