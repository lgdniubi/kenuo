...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function importFileTemplate(){
			window.location.href= '${ctx}/train/examlist/import/template';
		}
...
<body>
	<form id="inputForm" action="${ctx}/train/examlist/import" method="post" enctype="multipart/form-data" style="padding-left:20px;"><br/>
