		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
		      ...
		      <tr>
		         ...
		         <td>
		         	<label>${trainLiveAudit.userName}</label>
					 <%-- <form:input path="userName" htmlEscape="false" maxlength="50" class="form-control" readonly="true"/> --%>
				</td>
		     	 </tr>
		     	 <tr>
		      	 	<td><label class="pull-right">申请人描述:</label></td>
		         	<td>
		         		<label>${trainLiveAudit.remarks}</label>
		         		<%-- <form:input path="remarks" htmlEscape="false" maxlength="64" class="form-control" readonly="true"/> --%>
		         	</td>
		      	</tr>
		      	...
		      	<tr>
		         	...
		         	<td>
		         		<label>${trainLiveAudit.title}</label>
		         		<%-- <form:input path="title" htmlEscape="false" maxlength="30" class="form-control"  readonly="true"/> --%>
		         	</td>
		         </tr>
		         <tr>
		      		<td><label class="pull-right">直播房间名称:</label></td>
		         	<td>
		         		<label>${trainLiveAudit.name}</label>
		         		<%-- <form:input path="name" htmlEscape="false" maxlength="300" class="form-control"  readonly="true"/> --%>
		         	</td>
		      	</tr>
		      	<tr>
		      		<td><label class="pull-right">是否设置密码:</label></td>
		      		<td>
		      			<c:if test="${trainLiveAudit.authtype==1}">
			      			<label><input id="authtype" name="authtype" type="radio" value="1" checked="checked" class="form"/>有 </label>&nbsp;
			      			<label><input id="authtype" name="authtype" type="radio" value="2" class="form"/>无</label>
		      			</c:if>
		      			<c:if test="${trainLiveAudit.authtype==2}">
			      			<label><input id="authtype" name="authtype" type="radio" value="1" class="form-control"/>有 </label>&nbsp;
			      			<label><input id="authtype" name="authtype" type="radio" value="2" checked="checked" class="form"/>无</label>
		      			</c:if>
		      		</td>
		      	</tr>
		      	<tr>
		         	...
		         	<td>
		         		<label>${trainLiveAudit.desc}</label>
		         		<%-- <form:input path="desc" htmlEscape="false" maxlength="300" class="form-control" readonly="true"/> --%>
		         	</td>
		      	</tr>
		      	<tr>
		      	...
		      	<td>
		      	<input id="oldStatus" name="oldStatus" type="hidden" value="${trainLiveAudit.auditStatus}" />
		      	...
		      	<tr>
		      		<td><label class="pull-right">备注说明（<font color="red">审核失败必须说明</font>）：</label></td>
		      		<td>
		      			<form:textarea path="liveRemarks"  htmlEscape="false" rows="3" maxlength="300" class="form-control" ></form:textarea>
		      		</td>
		      	</tr>
		      	<tr>
		      		<td><label class="pull-right">直播封面图片:</label></td>
		      		<td>
		      			<img alt="封面图片" src="${trainLiveAudit.imgurl}" style="height:300px;width:450px">
		      		</td>
		      	</tr>
