...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function importFileTemplate(){
			window.location.href= '${ctx}/train/liveUser/import/template';
		}
...
<body>
	<form id="inputForm" action="${ctx}/train/liveUser/import" method="post" enctype="multipart/form-data" style="padding-left:20px;"><br/>
