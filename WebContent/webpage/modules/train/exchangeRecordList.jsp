	...
	<div class="wrapper wrapper-content">
		<div class="ibox">
			...
			<div class="ibox-content">
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="trainLiveRecord" action="${ctx}/train/record/exchangeRecordList" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
					<thead>
						<tr>
							...
							<th style="text-align: center;">兑换单号</th>
							<th style="text-align: center;">兑换云币数量</th>
							<th style="text-align: center;">消耗佣金</th>
