            ...
            <div class="ibox-content">
                <div class="searcharea clearfix">
					...
					<div class="row" style="padding-bottom: 5px;">
						<div class="col-sm-12">
	                        <div class="pull-left">
	                        	<button id="addexam" class="btn btn-white btn-sm" title="添加" onclick="addAllExam()" disabled="disabled">
									<i class="fa fa-plus"></i>批量添加
								</button>
								<button class="btn btn-white btn-sm" title="随机试题" onclick="openDialog('随机试题', '${ctx}/train/exambank/random?lessonId=${lessonId }&ziCategoryId=${ziCategoryId }&lessontype=${lessontype }','800px', '500px')" data-placement="left" data-toggle="tooltip">
