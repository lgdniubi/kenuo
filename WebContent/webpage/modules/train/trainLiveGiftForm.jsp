		...
		<div class="ibox">
	    	...
	    	<div class="ibox-content">
				<div class="tab-content" id="tab-content">
	                <div class="tab-inner">
						<form id="inputForm" action="${ctx}/train/liveGift/save">
							<input class="form-control" id="trainLiveGiftId" name="trainLiveGiftId" type="hidden" value="${trainLiveGift.trainLiveGiftId}"/>
							<table id="contentTable" class="table table-striped table-bordered  table-hover table-condensed  dataTables-example dataTable no-footer">
								<tr>
									<td><label class="pull-right"><font color="red">*</font>礼物名称：</label></td>
									<td>
										<input class="form-control required" id="name" name="name" type="text" value="${trainLiveGift.name }" style="width: 300px"/>
									</td>
								</tr>
								<tr>
									<td><label class="pull-right"><font color="red">*</font>图片：</label></td>
									<td>
										<img id="img" src="${trainLiveGift.imgUrl }" alt="" style="width: 200px;height: 100px;" />
										<input class="form-control" id="imgUrl" name="imgUrl" type="hidden" value="${trainLiveGift.imgUrl }"/><!-- 图片隐藏文本框 -->
								...
								<tr>
									...
									<td>
										<input class="form-control required" id="sort" name="sort" type="text" value="${trainLiveGift.sort }" style="width: 300px"/>
									</td>
								</tr>
							</table>
						</form>
