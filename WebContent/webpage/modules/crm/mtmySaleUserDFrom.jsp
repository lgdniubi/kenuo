				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
					...
					<tbody>
						<tr>
							...
							<td>${mtmySaleRelieve.newusers.nickname}</td>
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
					...
					<tbody>
						<tr>
							...
							<td>
								<a href="#" onclick="openDialog('收益明细', '${ctx}/ec/mtmySale/userEarnings?receiveUser=${mtmySaleRelieve.users.userid}','750px', '600px')"
