				...
				<table id="contentTable"
					...
					<tbody>
						<tr>
							...
							<td><c:if
									test="${BCmtmyRuleParam.paramValue - mtmySaleRelieve.ABnum < 0}">
									0
								</c:if> <c:if
									test="${BCmtmyRuleParam.paramValue - mtmySaleRelieve.ABnum >= 0}">
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="mtmySaleRelieve"
							action="${ctx}/ec/mtmySale/otherUserFrom" method="post"
							class="form-inline">
	...
	<div class="modal fade bs-example-modal-lg in" id="modal" tabindex="-1"
		...
		<form id="" class="modal-dialog modal-lg"
			...
			<input name="parentId" id="parentId" type="hidden"> <input
				...
				name="moveType" id="moveType" value="BFrom" type="hidden">
