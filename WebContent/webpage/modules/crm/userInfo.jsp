				...
				<fieldset id="fieldset" disabled="disabled">
					...
					<div class="ibox-content">
						<div class="clearfix">
							...
							<div class="row" style="text-align: center; margin: 10px">
								...
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>客户性别:</label> <select id="sex"
										...
										<option value="0"
											<c:if test="${detail.name=='0'}">selected="true"</c:if>>保密</option>
										<option value="1"
											<c:if test="${detail.name=='1'}">selected="true"</c:if>>男</option>
										<option value="2"
											<c:if test="${detail.name=='2'}">selected="true"</c:if>>女</option>
									</select>
								</div>
								<div class="col-sm-2 col-offset-sm-1">
								...
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>阴历生日:</label> <input
										id="lunar" name="lunarBirthday"
										value="${detail.lunarBirthday}" maxlength="50"
										style="width: 150px;" class="form-control">
								</div>
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>客户星座:</label> <select
										id="constellation" name="constellation" style="width: 150px;"
										class="form-control">
										<option></option>
										<c:forEach items="${constellation}" var="con">
											<option value="${con.value}"
												<c:if test="${con.value eq detail.constellation}">selected="true"</c:if>>${con.label}</option>
										</c:forEach>
									</select>
								</div>
							</div>
							<div class="row" style="text-align: center; margin: 10px">
								...
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>客户性格:</label> <select
										id="character" name="character" style="width: 150px;"
										class="form-control">
										<option></option>
										<c:forEach items="${character}" var="cha">
											<option value="${cha.value}"
												<c:if test="${cha.value eq detail.character}">selected="true"</c:if>>${cha.label}</option>
										</c:forEach>
									</select>
								</div>
								<div class="col-sm-2 col-offset-sm-1">
								...
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>婚姻状况:</label> <select
										id="isMarrige" name="isMarrige" style="width: 150px;"
										class="form-control">
										<option></option>
										<c:forEach items="${isMarrige}" var="con">
											<option value="${con.value}"
												<c:if test="${con.value eq detail.isMarrige}">selected="true"</c:if>>${con.label}</option>
										</c:forEach>
									</select>
								</div>
							</div>
							<div class="row" style="text-align: center; margin: 10px">
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>结婚纪念:</label> <input
										id="weddingDay" name="weddingDay" type="text"
										class="form-control" value='${detail.weddingDay}'
										style="width: 150px;">
								</div>
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>房产情况:</label> <select
										id="isEstate" name="isEstate" style="width: 150px;"
										class="form-control">
										<c:forEach items="${isEstate}" var="con">
											<option value="${con.value}"
												<c:if test="${con.value eq detail.isEstate}">selected="true"</c:if>>${con.label}</option>
										</c:forEach>
									</select>
								</div>
								<div class="col-sm-2 col-offset-sm-1">
								...
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>汽车品牌:</label> <select
										id="carBrand" name="carBrand" style="width: 150px;"
										class="form-control">
										<option></option>
										<c:forEach items="${carBrand}" var="con">
											<option value="${con.value}"
												<c:if test="${con.value eq detail.carBrand}">selected="true"</c:if>>${con.label}</option>
										</c:forEach>
									</select>
								</div>
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>子女人数:</label> <select
										id="children" name="children" style="width: 150px;"
										class="form-control">
										<option value="0"
											<c:if test="${detail.children=='0'}">selected="true"</c:if>>无</option>
										<option value="1"
											<c:if test="${detail.children=='1'}">selected="true"</c:if>>1</option>
										<option value="2"
											<c:if test="${detail.children=='2'}">selected="true"</c:if>>2</option>
										<option value="3"
											<c:if test="${detail.children=='3'}">selected="true"</c:if>>3</option>
										<option value="4"
											<c:if test="${detail.children=='4'}">selected="true"</c:if>>4</option>
									</select>
								</div>
							</div>
							<div class="row" style="text-align: center; margin: 10px">
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"></font>客户职业:</label><select
										id="occupation" name="occupation" style="width: 150px;"
										class="form-control">
										<option></option>
										<c:forEach items="${occupation}" var="con">
											<option value="${con.value}"
												<c:if test="${con.value eq detail.occupation}">selected="true"</c:if>>${con.label}</option>
										</c:forEach>
									</select>
								</div>
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>月收入:&nbsp;&nbsp;&nbsp;</label>
									<select id="income" name="income" style="width: 150px;"
										class="form-control">
										<option></option>
										<c:forEach items="${income}" var="con">
											<option value="${con.value}"
												<c:if test="${con.value eq detail.income}">selected="true"</c:if>>${con.label}</option>
										</c:forEach>
									</select>
								</div>
								<div class="col-sm-2 col-offset-sm-1">
								...
								<div class="col-sm-2 col-offset-sm-1">
									<label><font color="red"> </font>例假天数:</label> <input
										value="${detail.menstrualPeroid}" style="width: 150px;"
...
<%-- 									<sys:treeselect id="beautyId" name="beautyId" value="${detail.beautyId}" labelName="beautyName" labelValue="${detail.beautyName}"  --%>
							...
							<div class="row" style="text-align: center; margin: 10px">
								...
								<div class="col-md-6" style="margin-left: -123px">
									<label style="float: left"><font color="red"> </font>重大疾病:&nbsp;&nbsp;</label>
									<input value="${detail.criticalDiseases}" maxlength="50"
							...
							<div class="ibox-content">
								<div class="clearfix">
									<div class="row">
										<div class="col-md-8">
											<h3 style="color: blue">其他信息</h3>
											<br>
										</div>
									</div>
									<div class="row" style="margin: 10px">
										<div class="col-md-1">
											<label><font color="red"> </font>现用美容品牌:</label>
										</div>
										<div class="col-md-6">
											<input value="${detail.usingBrand}" maxlength="50"
												style="width: 300px;" name="usingBrand"
												class="form-control " />
										</div>
									</div>
									<div class="row" style="margin: 10px">
										<div class="col-md-1">
											<label><font color="red"> </font>兴趣爱好:</label>
										</div>
										<div class="col-md-6">
											<input value="${detail.intrest}" maxlength="50"
												style="width: 300px;" name="intrest" class="form-control " />
										</div>
									</div>
									<div class="row" style="margin: 10px">
										<div class="col-md-1">
											<label><font color="red"> </font>客户忌讳:</label>
										</div>
										<div class="col-md-3">
											<input value="${detail.usingBrand}" maxlength="50"
									...
									<div class="row" style="margin: 10px">
										<div class="col-md-1">
											<label><font color="red"> </font>客户讨厌:</label>
										</div>
										<div class="col-md-6">
											<input name="hate" value="${detail.hate}" maxlength="50"
					...
					<div class="ibox-content">
						<div class="clearfix">
							...
							<div class="row" style="text-align: center; margin: 10px">
								...
								<div class="col-md-2" style="margin-left: -20px">
									<label><font color="red"> </font>微信号码:</label> <input
										name="wechat" value="${info.wechat}" maxlength="50"
										style="width: 150px;" class="form-control " />
								</div>
								<div class="col-md-2" style="margin-left: -20px">
									<label><font color="red"> </font>邮件地址:</label> <input
							...
							<div class="row" style="margin: 10px">
								<shiro:hasPermission name="crm:userSecret:view">
								<div class="col-md-8">
									<label style="margin-left: 10px"><font color="red">
									</font>工作单位:</label> <input value="${info.companyName}" style="width: 300px;"
							...
							<div class="row" style="margin: 10px">
								<div class="col-md-8">
									...
									<input value="${info.address}" style="width: 300px;"
		...
		<div align="center">
			...
			<div align="center" class="col-md-3">
				<button onclick="enableEdit()" type="button" style="float:right"class="btn btn-info" id="enableEdit">编辑</button>
			</div>
			<div align="center" class="col-md-3">
