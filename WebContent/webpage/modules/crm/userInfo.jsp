				...
				<fieldset id="fieldset" disabled="disabled">
						...
						<div class="clearfix">
							...
							<div class="col-intems">
								<label><font color="red"> </font>客户性别:</label> <select id="sex"
									...
									<option value="1"
										<c:if test="${userDetail.sex=='1'}">selected="true"</c:if>>男</option>
									<option value="2"
										<c:if test="${userDetail.sex=='2'}">selected="true"</c:if>>女</option>
								</select>
							</div>
							<div class="col-intems">
							...
							<div class="col-intems">
								<label><font color="red"> </font>月 收 入:</label>
							...
							<div class="col-intems">
								<label style="margin-left: -10px; float: left"><font color="red"></font>所属美容师:</label>
								<div class="input-group" style="width: 148px; margin-right: 10px">
									<input id="beautyName" name="beautyName" readonly="readonly" type="text" class="form-control" value="${userDetail.beautyName}">
									<span class="input-group-btn">
										<button type="button" id="beautyButton" class="btn btn-primary  ">
											<i class="fa fa-search"></i>
										</button>
									</span>
									<input id="beautyId" name="beautyId" type="hidden" value="${userDetail.beautyId}">
								</div>
					...
					<div class="ibox-content">
						<div class="clearfix">
							...
							<div class="row" style="margin: 10px">
								<div class="col-item-1">
									<label><font color="red"> </font>兴 趣 爱 好:</label>
								</div>
								<div class="col-md-6">
							...
							<div class="row" style="margin: 10px">
								<div class="col-item-1">
									<label><font color="red"> </font>客 户 讨 厌:</label>
								</div>
								<div class="col-md-6">
