...
<script type="text/javascript">
		...
		function addActionGoods(){
			...
			top.layer.open({
			    ...
			    area: ['800px', '550px'],
			    title:"添加商品",
			    content: "${ctx}/ec/orders/addOderGoods?isNeworder="+isNeworder,
			    btn: ['确定', '关闭'],
	...
	function delFile(obj,costPrice,orderAmount,spareMoney,afterPayment,debtMoney){
		...
		$("#totalamount").val($("#totalamount").val()-afterPayment); //实付总额
...
<body>
	<div class="ibox-content">
		<div class="clearfix">
			<form:form id="inputForm" modelAttribute="orders" action="${ctx}/crm/orders/saveVirtualOrder" method="post" class="form-horizontal">
