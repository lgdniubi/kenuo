...
<div class="ibox-title">
	...
	<div class="row">
	<div class="col-sm-12">
		<form:form id="searchForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/" method="post" class="form-inline">
	...
	<div class="col-sm-12">
		<div class="pull-left">
			<shiro:hasPermission name="oa:oaNotify:add">
				<table:addRow url="${ctx}/oa/oaNotify/form?isSelf=false" title="通知"></table:addRow><!-- 增加按钮 -->
			</shiro:hasPermission>
			...
			<shiro:hasPermission name="oa:oaNotify:del">
				<table:delRow url="${ctx}/oa/oaNotify/deleteAll" id="contentTable" isSelf="false"></table:delRow><!-- 删除按钮 -->
			</shiro:hasPermission>
		...
		<c:forEach items="${page.list}" var="oaNotify">
			<tr>
				...
				<td>
					...
					<shiro:hasPermission name="oa:oaNotify:edit">
    					<a href="#" onclick="openDialog('修改通知', '${ctx}/oa/oaNotify/form?id=${oaNotify.id}&isSelf=false','800px', '500px')" class="btn btn-success btn-xs btn-circle" ><i class="fa fa-edit"></i></a>
    				</shiro:hasPermission>
    				<shiro:hasPermission name="oa:oaNotify:del">
						<a href="${ctx}/oa/oaNotify/delete?id=${oaNotify.id}&isSelf=false" onclick="return confirmx('确认要删除该通知吗？', this.href)"   class="btn btn-danger btn-xs btn-circle"><i class="fa fa-trash"></i></a>
					</shiro:hasPermission>

					<shiro:hasPermission name="oa:oaNotify:pushMsg">
					...
					<shiro:hasPermission name="oa:oaNotify:getPushResult">
