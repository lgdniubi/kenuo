...
<script type="text/javascript">
	...
	function addGoods(id,flag,positionType,isOpen){
		top.layer.open({
		    type: 2, 
		    area: ['900px', '550px'],
		    title:"添加商品",
		    content: "${ctx}/ec/webAd/mtmyWebAdGoodsForm?adId="+id+"&flag="+flag+"&positionType="+positionType+"&isOpen="+isOpen,
		    btn: ['确定', '关闭'],
	...
	<div class="wrapper wrapper-content">
		<div class="ibox">
			<div class="ibox-content">
				...
				<div>
					<a href="#" onclick="addGoods(${mtmyWebAd.mtmyWebAdId},'add',${mtmyWebAd.positionType},'${mtmyWebAd.isOpen}')" class="btn btn-primary btn-xs" ><i class="fa fa-plus"></i>添加商品</a>
				</div>
				<p></p>
