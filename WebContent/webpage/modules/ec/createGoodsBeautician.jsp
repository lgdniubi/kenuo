		...
		// 是否限制选择，如果限制，设置为disabled
			...
			if(cateid == "0" || cateid == ""){
				...
				top.layer.open({
				    ...
				    content: "${ctx}/tag/treeselect?url="+encodeURIComponent("/ec/goods/treeGoodsData?goodsCategory="+cateid)+"&module=&checked=&extId=&isAll=",
				    btn: ['确定', '关闭']
		    	       ,yes: function(index, layero){ //或者使用btn1
								var tree = layero.find("iframe")[0].contentWindow.tree;//h.find("iframe").contents();
								var ids = [], names = [], nodes = [];
	...
	<div class="wrapper wrapper-content">
		<div class="ibox">
			<div class="ibox-content">
				<div class="clearfix">
					<form:form id="inputForm" modelAttribute="goodsBeauticianFee" action="${ctx}/ec/beautician/saveCreate" method="post" class="form-horizontal">
						<div class="pull-left">
						...
						<div style="clear:both;padding-top:10px;" >
							<label >规格选择：</label>
							<select id="specgoods" onchange="selectspecprice(this)" style="width: 180px;height:30px;">
						...
						<p></p>
						<label >系统价格：</label>
						<input id="costPrice" name="costPrice" maxlength="10" class="form-control required" readonly="true"  style="width:150px;height:30px;"/>
						<label >市场价格：</label>
						<input id="marketprice" name="marketprice" name="marketprice" maxlength="10" class="form-control" readonly="true"  style="width:150px;height:30px;"/>
						<p></p>
						<label >优惠价格：</label>
						<input id="couponprice" name="couponprice" maxlength="10" class="form-control required" readonly="true"   style="width:150px;height:30px;"/>
						<label >成交价格：</label>
						<input id="orderamount" name="orderamount" maxlength="10" class="form-control required"  readonly="true" style="width:150px;height:30px;"/>
						<hr>
						<p></p>
						<label ><font color="red">*</font>项目基础业绩：</label>
						<input id="basisFee" name="basisFee" maxlength="10" class="form-control required"  style="width:150px;height:30px;"/>
						<p></p>
						<label ><font color="red">*</font>初级费用:</label>
						<input id="primary" name="primary" maxlength="10" class="form-control required"  style="width:150px;height:30px;"/>
						<label ><font color="red">*</font>中级费用:</label>
						<input id="middle" name="middle" maxlength="10" class="form-control required"  style="width:150px;height:30px;"/>
						<p></p>
