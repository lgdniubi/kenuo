		...
		<div class="ibox">
	    	...
	    	<div class="ibox-content">
				<div class="tab-content" id="tab-content">
	                <div class="tab-inner">
						<form:form id="inputForm" modelAttribute="webMainmenuNavbar" action="${ctx}/ec/webMainmenuNavbar/save">
							<form:hidden path="webMainmenuNavbarId"/>
								...
								<tr>
									...
									<td>
										<form:select path="type" class="form-control">
											...
											<form:option value="2">商城</form:option>
											<form:option value="3">生活美容</form:option>
										</form:select>
									</td>
								</tr>
								<tr>
									...
									<td>
										<form:textarea path="remarks" class="form-control" style="resize: none;" cols="37" rows="4"/>
									</td>
								</tr>
							</table>
						</form:form>
