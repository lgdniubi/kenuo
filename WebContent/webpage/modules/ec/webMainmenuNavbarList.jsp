						...
						<tr>
							...
							<td style="text-align: center;">
								...
								<shiro:hasPermission name="ec:webMainmenuNavbarContent:view">
									<a href="#" onclick="openDialogView('主菜单导航栏内容图', '${ctx}/ec/webMainmenuNavbarContent/list?webMainmenuNavbarId=${webMainmenuNavbar.webMainmenuNavbarId}&type=${webMainmenuNavbar.type}','800px', '600px')" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> 主菜单导航栏内容图</a>
								</shiro:hasPermission>
							</td>
						</tr>
						</c:forEach>
