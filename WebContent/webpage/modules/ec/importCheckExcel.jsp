...
<html>
<head>
	<title>ping++数据导入</title>
	<meta name="decorator" content="default"/>
	<script type="text/javascript" language="javascript">
		//导出下载模板	
		function importFileTemplate(){
			window.location.href= '${ctx}/ec/mtmyCheck/import/template';
		}	
...
<body>
	<form id="inputForm" action="${ctx}/ec/mtmyCheck/import" method="post" enctype="multipart/form-data" style="padding-left:20px;"><br/>
