...
<body>
	<div class="wrapper wrapper-content">
		<div class="ibox">
			...
			<div class="ibox-content">
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="mtmySaleRelieve" action="${ctx}/ec/mtmySale/findAllD" method="post" class="form-inline">
					...
					<tbody>
						<c:forEach items="${page.list}" var="mtmySaleRelieve">
							<tr>
								...
								<td>
									<a href="#" onclick='top.openTab("${ctx}/ec/mtmySale/DUserFrom?users.userid=${mtmySaleRelieve.users.userid}","D级用户详情", false)' class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
	...
	<div class="modal fade bs-example-modal-lg in" id="modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display: none; padding-right: 17px;">
   		<form id="" class="modal-dialog modal-lg" action="${ctx}/ec/mtmySale/move">
   			...
   			<input name="moveType" id="moveType" value="DList" type="hidden">
