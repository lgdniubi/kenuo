	...
	<div class="wrapper wrapper-content">
		<div class="ibox">
			...
			<div class="ibox-content">
				<div class="clearfix">
					<form:form id="searchForm" modelAttribute="integralsLog" action="${ctx}/ec/integralsLog/list" method="post" class="form-inline">
						<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
						<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
						<div class="form-group">
							<form:input path="" htmlEscape="false" maxlength="50" class=" form-control input-sm" placeholder="用户名"/>
							<form:input path="" htmlEscape="false" maxlength="50" class=" form-control input-sm" placeholder="手机号"/>
							<form:input path="" htmlEscape="false" maxlength="50" class=" form-control input-sm" placeholder="订单号"/>
							<label>发票类型：</label>
								<form:select path=""  class="form-control" style="width:185px;">
