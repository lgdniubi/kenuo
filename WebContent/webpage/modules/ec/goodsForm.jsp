...
//			$("#goodsCategoryIdButton, #goodsCategoryIdName").click(function(){	    增加  , #goodsCategoryIdName  文本框有点击事件
			$("#goodsCategoryIdButton").click(function(){
				...
				top.layer.open({
				    ...
				    content: "/kenuo/a/tag/treeselect?url="+encodeURIComponent("/ec/goodscategory/treeData?positionType=")+"&module=&checked=&extId=&isAll=&selectIds=&positionType="+$("#isReal").val(),
				    btn: ['确定', '关闭']
										...
										<div style="width: 40%;padding-left: 150px;">
						                    <sys:treeselect id="equipmentLabel" name="equipmentLabel.id" value="${goods.equipmentLabel.id}" 
												labelName="equipmentLabel.name" labelValue="${goods.equipmentLabel.name }" 
									     		title="设备标签" url="/ec/equipmentLabel/newTreeData" cssClass="form-control" allowClear="true" notAllowSelectParent="true" checked="true"/>
