...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function importFileTemplate(){
			window.location.href= '${ctx}/ec/orders/importVirtualOrders/template';
		}
...
<body>
	<form id="inputForm" action="${ctx}/ec/orders/importVirtualOrders" method="post" enctype="multipart/form-data" style="padding-left:20px;"><br/>
