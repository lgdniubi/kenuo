...
<script type="text/javascript">
		...
		function addActionGoods(){
			...
			top.layer.open({
			    ...
			    area: ['800px', '550px'],
			    title:"添加商品",
			    content: "${ctx}/ec/orders/addAfterSaleSuitCardOderGoods?isNeworder=0",
			    btn: ['确定', '关闭'],
			    yes: function(index, layero){
					...
					$.ajax({
						type:"post",
						async: false,
						url:"${ctx}/ec/orders/selectAfterSaleSuitCardSon",
						data:{
...
<body>
	<div class="ibox-content">
		<div class="clearfix">
			<form:form id="inputForm" modelAttribute="orders" action="${ctx}/ec/orders/saveAfterSaleSuitCardOrder" method="post" class="form-horizontal">
