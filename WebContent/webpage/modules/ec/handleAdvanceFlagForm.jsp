				...
				<div class="tab-content" id="tab-content">
	                <div class="tab-inner">
						...
						<c:if test="${orderGoods.advanceServiceTimes == 0}">
							...
							（账户可用余额：<input type="text" id="accountBalance" name="accountBalance" readonly="readonly" value="${orderGoods.accountBalance}" class="form-control required" style="width:150px;"  />）
						</c:if>
