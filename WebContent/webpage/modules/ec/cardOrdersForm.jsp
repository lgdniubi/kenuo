			...
			<div class="ibox-content">
				<div class="clearfix">
					...
					<shiro:hasPermission name="ec:orders:edit">
						...
						<c:if test="${type != 'view' }">
							<c:choose>
								<c:when test="${(orders.channelFlag != 'bm' && ((orders.advanceFlag > 0 && ((orders.sumAppt == 0) || (orders.sumAppt > 0 && orders.apptFlag == 0))) || (orders.changeAdvanceFlag > 0 && orders.returnedFlag == 0))) || (orders.channelFlag == 'bm' && (((orders.sumAppt == 0) || (orders.sumAppt > 0 && orders.apptFlag == 0)) && orders.returnedFlag == 0))}">
