...
<body>
	<form:form id="inputForm" modelAttribute="returnedGoods" action="${ctx}/ec/returned/UpdateShipping" method="post" class="form-horizontal">
				...
				<tr>
			        <td class="active"><label class="pull-right">发货时间:</label></td>
			         <td><input id="shippingTime" name="shippingTime" type="text" maxlength="20" class="laydate-icon form-control layer-date input-sm required"
							value="<fmt:formatDate value="${returnedGoods.shippingTime}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
					</td>
			      </tr>
			      <tr>
