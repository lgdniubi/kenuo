					...
					<tbody>
						<c:forEach items="${page.list}" var="mtmySaleRelieve">
							<tr>
								...
								<td>
									<a href="#" onclick='top.openTab("${ctx}/ec/mtmySale/findChild?users.userid=${mtmySaleRelieve.users.userid}&moveType=${mtmySaleRelieve.users.layer }","用户详情", false)' class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看用户详情</a>
									<a href="#" onclick="openDialogView('查看记录', '${ctx}/ec/mtmySale/userDetails?users.nickname=${mtmySaleRelieve.users.nickname}&rebateUser=${mtmySaleRelieve.users.userid}&receiveUser=${mtmySaleRelieve.parentId}','750px', '600px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看记录</a>
