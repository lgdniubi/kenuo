...
<script type="text/javascript">
		...
		function addActionGoods(){
			...
			top.layer.open({
			    ...
			    area: ['800px', '550px'],
			    title:"添加商品",
			    content: "${ctx}/ec/orders/addAfterSaleCommonOderGoods?isNeworder=0",
			    btn: ['确定', '关闭'],
			    yes: function(index, layero){
					...
					$.ajax({
						type:"post",
						async: false,
						url:"${ctx}/ec/orders/selectAfterSaleCommonCardSon",
						data:{
							...
							actualSpeckeyNum:$(actualSpeckeyNum).val()
						 },
...
<body>
	<div class="ibox-content">
		<div class="clearfix">
			<form:form id="inputForm" modelAttribute="orders" action="${ctx}/ec/orders/saveAfterSaleCommonCardlOrder" method="post" class="form-horizontal">
				<label><font color="red">*</font>手机号码：</label>
				<input id="mobile" name="mobile" value="${orders.mobile}" maxlength="11" class="form-control required" readonly="readonly"style="width:200px"/>&nbsp;&nbsp;
				<label><font color="red">*</font>昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：</label>
				<input id="username" name="username" value="${orders.username}" type="text" class="form-control required" readonly="readonly" style="width:200px" />
