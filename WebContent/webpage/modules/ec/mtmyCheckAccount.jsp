								...
								<th>
									<c:if test="${mtmyCheckAccount.orderId ne null}">
										<shiro:hasPermission name="ec:mtmyCheck:view"> 
					 						...
					 						<a href="#" onclick="openDialogView('查看订单', '${ctx}/ec/orders/orderform?orderid=${mtmyCheckAccount.orderId}&isReal=${mtmyCheckAccount.isReal}&type=view','1100px','650px')" class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 订单详情</a>
					 					</shiro:hasPermission>
									</c:if>
								</th>
							</tr>
