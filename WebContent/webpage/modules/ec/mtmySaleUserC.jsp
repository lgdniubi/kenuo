...
<body>
	<div class="wrapper wrapper-content">
		<div class="ibox">
			...
			<div class="ibox-content">
				...
				<div class="row">
					<div class="col-sm-12">
						<form:form id="searchForm" modelAttribute="mtmySaleRelieve" action="${ctx}/ec/mtmySale/findAllC" method="post" class="form-inline">
				...
				<table id="contentTable" class="table table-striped table-bordered table-hover table-condensed dataTables-example dataTable">
					<thead>
						<tr>
							...
							<th class="sort-column rc.ABnum">C级用户</th>
							<th>剩余C级用户</th>
					...
					<tbody>
						<c:forEach items="${page.list}" var="mtmySaleRelieve">
							<tr>
								...
								<td>
									<c:if test="${CDmtmyRuleParam.paramValue - mtmySaleRelieve.ABnum < 0}">
										0
									</c:if>
									<c:if test="${CDmtmyRuleParam.paramValue - mtmySaleRelieve.ABnum >= 0}">
										${CDmtmyRuleParam.paramValue - mtmySaleRelieve.ABnum }
									</c:if>
								</td>
								...
								<td>
									<a href="#" onclick='top.openTab("${ctx}/ec/mtmySale/CUserFrom?users.userid=${mtmySaleRelieve.users.userid}","AB用户详情", false)' class="btn btn-info btn-xs" ><i class="fa fa-search-plus"></i> 查看</a>
	...
	<div class="modal fade bs-example-modal-lg in" id="modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" style="display: none; padding-right: 17px;">
   		<form id="" class="modal-dialog modal-lg" action="${ctx}/ec/mtmySale/move">
   			...
   			<input name="moveType" id="moveType" value="CList" type="hidden">
