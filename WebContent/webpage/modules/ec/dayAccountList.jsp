	...
	<div class="wrapper wrapper-content">
		<div class="ibox">
			...
			<div class="ibox-content">
				<div class="clearfix">
					<form:form id="searchForm" modelAttribute="dayAccount" action="${ctx}/ec/dayaccount/list" method="post"
						class="form-inline">
						...
						<div class="form-group">
							...
							value="<fmt:formatDate value="${dayAccount.startTime}" pattern="yyyy-MM-dd"/>" style="width:185px;" placeholder="开始时间" readonly="readonly"/>
							一
							<input id="endTime" name="endTime" type="text" maxlength="20" class=" laydate-icon form-control layer-date input-sm" 
							value="<fmt:formatDate value="${dayAccount.endTime}" pattern="yyyy-MM-dd"/>"  style="width:185px;" placeholder="结束时间" readonly="readonly"/>&nbsp;&nbsp;
