...
<head>
	...
	<script type="text/javascript" language="javascript">
		...
		function importFileTemplate(){
			window.location.href= '${ctx}/ec/orders/import/template';
		}
...
<body>
	<form id="inputForm" action="${ctx}/ec/orders/import" method="post" enctype="multipart/form-data" style="padding-left:20px;"><br/>
