	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#franchiseeIdButton").click(function(){
				//数据在启用中,禁止修改商家(原因:可能会出现相同商家展示多个图片)
				if ($("#isShow").val() == 1){
				...
				top.layer.open({
				    ...
				    content: "/kenuo/a/tag/treeselect?url="+encodeURIComponent("/sys/franchisee/treeData")+"&module=&checked=&extId=&isAll=&selectIds=0" ,
				    btn: ['确定', '关闭']
								...
								<tr>
									...
									<td style="width: 40px">
										...
										<div class="input-group">
											<input id="franchiseeIdName" name="franchiseeName" readonly="readonly" type="text" value="${mtmyFranchiseeBanner.franchiseeName}" data-msg-required="" class="form-control required" style="" aria-required="true">
