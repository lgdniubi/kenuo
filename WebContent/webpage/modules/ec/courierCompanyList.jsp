							...
							<tr>
								...
								<td>
									<shiro:hasPermission name="ec:courierCompany:view">
										<a href="#" onclick="openDialogView('查看抢购活动', '${ctx}/ec/courierCompany/listform?id=${courier.id}','900px','600px')"
											class="btn btn-info btn-xs"><i class="fa fa-search-plus"></i>查看</a>
									</shiro:hasPermission>
									<shiro:hasPermission name="ec:courierCompany:edit">
										<a href="#" onclick="openDialog('编辑活动', '${ctx}/ec/courierCompany/form?id=${courier.id}','900px','600px')"
