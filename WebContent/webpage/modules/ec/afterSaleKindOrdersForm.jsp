...
<script type="text/javascript">
		...
		function addActionGoods(){
			...
			top.layer.open({
			    ...
			    area: ['800px', '550px'],
			    title:"添加商品",
			    content: "${ctx}/ec/orders/addAfterSaleKindOderGoods?isNeworder=0",
			    btn: ['确定', '关闭'],
...
<body>
	<div class="ibox-content">
		<div class="clearfix">                                                         
			<form:form id="inputForm" modelAttribute="orders" action="${ctx}/ec/orders/saveAfterSaleKindOrder" method="post" class="form-horizontal">
				<label><font color="red">*</font>手机号码：</label>
				<input id="mobile" name="mobile" maxlength="11" readonly="readonly" class="form-control required" value="${orders.mobile}" style="width:200px" />&nbsp;&nbsp;
