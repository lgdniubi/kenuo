...
<head>
	...
	<script type="text/javascript">
		...
		//退货列表111
		function returnedGoodsList(orderId,isReal){
							...
							<td>
								...
								<shiro:hasPermission name="ec:orders:edit"> 
			 				 	...
			 				 	<shiro:hasPermission name="ec:orders:return">
									<c:if test="${orders.orderstatus==4}">
										<a href="#" onclick="returnedGoodsList('${orders.orderid}','${orders.isReal}')"  class="btn btn-success btn-xs" ><i class="fa fa-edit"></i>售后服务</a>
									</c:if>
									<c:if test="${orders.orderstatus!=4}">
