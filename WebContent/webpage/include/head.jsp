<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="美业"/>
...
<!-- trains -->
<link href="${ctxStatic}/common/training.css" type="text/css" rel="stylesheet" />
<script src="${ctxStatic}/common/training.js" type="text/javascript"></script>
