...
import com.training.modules.ec.service.CategoryRecommendedService;
 ...
 * 品类推荐Controller
 * 
 * @version 蜜蜂 2018.12.1
 */
@Controller
@RequestMapping(value = "${adminPath}/ec/categoryRecommended")
public class CategoryRecommendedController extends BaseController{

	@Autowired
	private CategoryRecommendedService categoryRecommendedService;
	...
	public String list(MtmyCategoryRecommended mtmyCategoryRecommended,HttpServletRequest request, HttpServletResponse response,Model model) {
		try{
			Page<MtmyCategoryRecommended> page = categoryRecommendedService.findPage(new Page<MtmyCategoryRecommended>(request, response), mtmyCategoryRecommended);
		...
		return "modules/ec/categoryRecommendedList";
	}
