...
//			saveUserLog1(user);
			...
			String photo = (user.getPhoto() == null || "".equals(user.getPhoto())) ? null : user.getPhoto();//修改之后的美容师头像
			String oldPhoto = (oldUser.getPhoto() == null || "".equals(oldUser.getPhoto())) ? null : oldUser.getPhoto();//修改之前的美容师头像
			if(photo != null && !oldPhoto.equals(photo)){
