 ...
 */
package com.training.modules.sys.security;
...
import com.training.common.web.Servlets;
...
import com.training.modules.sys.web.LoginController;
...
public class SystemAuthorizingRealm extends AuthorizingRealm {
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
		...
		if (user != null) {
			...
			if (Global.NO.equals(user.getLoginFlag()) || !flag || Global.YES.equals(user.getDelFlag())){
