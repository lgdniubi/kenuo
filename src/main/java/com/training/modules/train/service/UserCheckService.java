...
//						+"\",\"charter_url\":\""+find.getCharterUrl()+"\"}";
	...
	private void updateSuperAdminMenu(ModelFranchisee modelFranchisee) {
		...
		TrainModel pcTrainModel = new TrainModel();
		pcTrainModel.setId(modelFranchisee.getModid());
		TrainModel fzxTrainModel = new TrainModel();
		fzxTrainModel.setId(modelFranchisee.getModid());
		TrainModel mdTrainModel = new TrainModel();
		mdTrainModel.setId(modelFranchisee.getModid());
		TrainModel pcMenu = trainModelService.findmodpcMenu(pcTrainModel );
		TrainModel mediaMenu = trainModelService.findmodMediaMenu(mdTrainModel);
		TrainModel fzxMenu = trainModelService.findmodfzxMenu(fzxTrainModel);
