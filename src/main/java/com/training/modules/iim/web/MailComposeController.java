 ...
 */
package com.training.modules.iim.web;
...
import com.training.modules.iim.service.MailBoxService;
import com.training.modules.iim.service.MailComposeService;
import com.training.modules.iim.service.MailService;
...
public class MailComposeController extends BaseController {
	...
	public String list(MailCompose mailCompose, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		//logger.info("#####[status]:"+mailCompose.getStatus());
	...
	public String delete(MailCompose mailCompose, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/iim/mailCompose/list?repage&status="+mailCompose.getStatus();
	}
	...
	public String deleteAllCompose(String ids, Model model, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/iim/mailCompose/list?repage&status=1";
	}
	...
	public String deleteAllDraft(String ids, RedirectAttributes redirectAttributes) {
		...
		return "redirect:"+Global.getAdminPath()+"/iim/mailCompose/list?repage&status=0";
	}
